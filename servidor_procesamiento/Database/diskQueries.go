...
// 	var disco models.Disco
// 	err := GormDB.Where("sistema_operativo = ? AND distribucion_sistema_operativo = ? AND host_id = ?", sistema_operativo, distribucion_sistema_operativo, id_host).First(&disco).Error
// 	if err != nil {
