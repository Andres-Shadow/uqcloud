                ...
                if (Array.isArray(contenedores)) {
                    ...
                    contenedores.forEach(function (contenedor) {
                        $("#contenedor-table tbody").append(
                            ...
                            <input type="hidden" name="IdContenedor" value="${contenedor.ConetendorId}">
                            <button type="submit" class="btn btn-link" style="padding: 0; margin: 0;">
                                <img style="width: 35px;" src="/web/static/img/icons/stop.png" alt="Botón 1">
                            </button>
                            </form>
                            ...
                            <input type="hidden" name="IdContenedor" value="${contenedor.ConetendorId}">
                            <button type="submit" class="btn btn-link" style="padding: 0; margin: 0;">
                                <img style="width: 35px;" src="/web/static/img/icons/restart.png" alt="Botón 1">
                            </button>
                            </form>
                            ...
                            <input type="hidden" name="IdContenedor" value="${contenedor.ConetendorId}">
                            <button type="submit" class="btn btn-link" style="padding: 0; margin: 0;">
                                <img style="width: 35px;" src="/web/static/img/icons/delete.png" alt="Botón 1">
                            </button>
                            </form>
